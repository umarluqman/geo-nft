    ...
    function generateSVGFigures(SVGParams memory params) private pure returns (string memory svg) {
        svg = string(
            abi.encodePacked(
                ...
                '<rect x="16" y="16" width="480" height="480" rx="16" ry="16" fill="rgba(0,0,0,0)" stroke="rgba(255,255,255,0.5)"></rect>',
                '<rect x="0" y="0" width="512" height="512" rx="26" ry="26" fill="rgba(0,0,0,0)" stroke="rgba(255,255,255,0.5)"></rect>'
            )
        );
    }
